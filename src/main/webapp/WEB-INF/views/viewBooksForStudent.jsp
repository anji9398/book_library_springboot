...
<title>view books for student</title>
<style type="text/css">
table, th, td {
...
<table  id="customers">
   ...
   <tbody>
      <c:forEach items="${listOfBooks}" var="i">
      <tr>
     ...
     <!--  <a href='edit?code="+bb.getCode()+"'>EditBook</a> -->
      <td><button class="button-35" role="button"><a href='addcart?code=${i.id}&name=${userName}'>Add cart</a></button></td>
          </tr><!-- <a href='page2.php?name=$name&age=$age'>Go to page 2</a> -->
      </c:forEach>
